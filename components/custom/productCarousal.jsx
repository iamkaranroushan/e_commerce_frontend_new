            ...
            {products.map((p) => {
              ...
              return (
                <div
                  ...
                  className="w-full h-full flex-shrink-0 flex flex-col lg:flex-row"
                >
                  ...
                  ">
                    {!p.imageUrl ? (
                      <div className="w-[55%] max-w-[320px] aspect-square animate-pulse rounded-xl" />
                    ) : (
                      <div
                      className="
                        relative 
                        w-full
                        max-w-[clamp(20rem,20vw,40rem)]   
                        flex
                        items-center
                        justify-center
                  ...
                  <div className="w-full lg:w-1/2 flex flex-col justify-center items-start py-[clamp(4rem,5vw,2rem)] px-[clamp(1rem,5vw,3rem)] bg-white">
                    ...
                    <div>
                      ...
                      <p className="text-stone-700 mb-6 leading-relaxed text-[clamp(0.8rem,2vw,1.2rem)] lg:text-[clamp(0.9rem,1vw,3rem)] max-w-[60%] md:max-w-[80%]">
                        {p.description}
                      </p>
